...
(function ($) {
    var $mol_speech = (function (_super) {
        ...
        $mol_speech.prototype.render = function () {
            var text = $mol_speech.text();
            if (text.match(this.matcher())) {
                this.event_catch(event);
            }
            return null;
        };
        $mol_speech.prototype.event_catch = function (event) {
            console.log(event);
        };
        $mol_speech.prototype.patterns = function () {
            return [];
        };
        $mol_speech.prototype.matcher = function () {
    ...
    __decorate([
        $.$mol_mem()
    ], $mol_speech.prototype, "matcher", null);
    __decorate([
        $.$mol_mem()
    ], $mol_speech, "api", null);
    __decorate([
...
(function ($) {
    var $mol_app_slides = (function (_super) {
        ...
        $mol_app_slides.prototype.Speech_next = function () {
            var _this = this;
            return new $.$mol_speech().setup(function (obj) {
        ...
        $mol_app_slides.prototype.slide_title = function () {
            return "";
        };
        ...
        $mol_app_slides.prototype.Speech_toggle = function () {
            var _this = this;
            return new $.$mol_check_icon().setup(function (obj) {
        ...
        $mol_app_slides.prototype.Listener = function () {
            ...
            return new $.$mol_page().setup(function (obj) {
                ...
                obj.title = function () { return _this.slide_title(); };
                obj.tools = function () { return [].concat(_this.Speech_toggle(), _this.Slide_number()); };
                obj.body = function () { return [].concat(_this.Listener_content()); };
            });
        };
        ...
        $mol_app_slides.prototype.Speaker = function () {
            ...
            return new $.$mol_page().setup(function (obj) {
                obj.minimal_width = function () { return 600; };
                obj.title = function () { return _this.slide_title(); };
                obj.tools = function () { return [].concat(_this.Open_listener(), _this.Slide_switcher()); };
        ...
        $mol_app_slides.prototype.pages = function () {
    ...
    (function ($mol) {
        var $mol_app_slides = (function (_super) {
            ...
            $mol_app_slides.prototype.event_load = function () {
                var _this = this;
                var frame = this.Loader().render();
                frame.contentWindow.postMessage(['content'], '*');
                window.onmessage = function (event) {
                    if (event.data[0] !== 'done')
                        return;
                    window.onmessage = null;
                    _this.contents(event.data[1].split(/^(?=#)/mg));
                };
            };
            $mol_app_slides.prototype.content = function () {
            ...
            $mol_app_slides.prototype.slide = function (next) {
                ...
                if (next < 0)
                    next = count - 1;
                var str = (next === void null) ? void null : String(next);
