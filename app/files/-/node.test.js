...
(function ($) {
    var $mol_embed = (function (_super) {
        ...
        $mol_embed.prototype.open_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "open_label");
        };
        $mol_embed.prototype.Open = function () {
            var _this = this;
...
(function ($) {
    var $mol_app_files = (function (_super) {
        ...
        $mol_app_files.prototype.Folder_row_info = function (uri) {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Folder_row_title(uri), _this.Folder_row_descr(uri)); };
            });
        };
...
(function ($) {
    var $mol_app_files_folder = (function (_super) {
        ...
        $mol_app_files_folder.prototype.body = function () {
            return [].concat(this.Description(), this.Status(), this.Folder_rows());
        };
