...
var $;
(function ($) {
    var $mol_perf_serp = (function (_super) {
        __extends($mol_perf_serp, _super);
        function $mol_perf_serp() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $mol_perf_serp.prototype.size_target = function () {
            return 25;
        };
        $mol_perf_serp.prototype.elapsed = function (val, force) {
            return (val !== void 0) ? val : 0;
        };
        $mol_perf_serp.prototype.transform = function () {
            return "";
        };
        $mol_perf_serp.prototype.style = function () {
            return ({
                "transform": this.transform(),
            });
        };
        $mol_perf_serp.prototype.left = function (id) {
            return 0;
        };
        $mol_perf_serp.prototype.top = function (id) {
            return 0;
        };
        $mol_perf_serp.prototype.size = function (id) {
            return 25;
        };
        $mol_perf_serp.prototype.text = function () {
            return "";
        };
        $mol_perf_serp.prototype.Dot = function (id) {
            var _this = this;
            return new $.$mol_perf_serp_dot().setup(function (obj) {
        ...
        return $mol_perf_serp;
    }($.$mol_view));
    __decorate([
        $.$mol_mem()
    ], $mol_perf_serp.prototype, "elapsed", null);
    __decorate([
        $.$mol_mem_key()
    ], $mol_perf_serp.prototype, "Dot", null);
    $.$mol_perf_serp = $mol_perf_serp;
})($ || ($ = {}));
(function ($) {
    var $mol_perf_serp_dot = (function (_super) {
        __extends($mol_perf_serp_dot, _super);
        function $mol_perf_serp_dot() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $mol_perf_serp_dot.prototype.size = function () {
            return 25;
        };
        $mol_perf_serp_dot.prototype.hover = function (val, force) {
            return (val !== void 0) ? val : false;
        };
        $mol_perf_serp_dot.prototype.text = function () {
            return "";
        };
        $mol_perf_serp_dot.prototype.sub = function () {
            return [].concat(this.text());
        };
        $mol_perf_serp_dot.prototype.width = function () {
            return this.size();
        };
        $mol_perf_serp_dot.prototype.height = function () {
            return this.size();
        };
        $mol_perf_serp_dot.prototype.left = function () {
            return 0;
        };
        $mol_perf_serp_dot.prototype.top = function () {
            return 0;
        };
        $mol_perf_serp_dot.prototype.radius = function () {
            return this.size();
        };
        $mol_perf_serp_dot.prototype.color = function () {
            return "";
        };
        $mol_perf_serp_dot.prototype.style = function () {
            return ({
                "width": this.width(),
                "height": this.height(),
                "left": this.left(),
        ...
        $mol_perf_serp_dot.prototype.enter = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $mol_perf_serp_dot.prototype.leave = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $mol_perf_serp_dot.prototype.event = function () {
            var _this = this;
            return ({
        ...
        return $mol_perf_serp_dot;
    }($.$mol_view));
    __decorate([
        $.$mol_mem()
    ], $mol_perf_serp_dot.prototype, "hover", null);
    __decorate([
        $.$mol_mem()
    ], $mol_perf_serp_dot.prototype, "enter", null);
    __decorate([
        $.$mol_mem()
    ], $mol_perf_serp_dot.prototype, "leave", null);
    $.$mol_perf_serp_dot = $mol_perf_serp_dot;
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($mol) {
        var $mol_perf_serp = (function (_super) {
            ...
            $mol_perf_serp.prototype.sub = function () {
                var _this = this;
                return this.data().map(function (props, index) { return _this.Dot(index); });
            };
            $mol_perf_serp.prototype.data = function () {
                return this.SierpinskiTriangle({ left: 0, top: 0, size: 1000 });
            };
            $mol_perf_serp.prototype.SierpinskiTriangle = function (id) {
            ...
            $mol_perf_serp.prototype.left = function (index) {
                return this.data()[index].left;
            };
            $mol_perf_serp.prototype.top = function (index) {
                return this.data()[index].top;
            };
            $mol_perf_serp.prototype.size = function (index) {
            ...
            $mol_perf_serp.prototype.update = function () {
                var _this = this;
                this.elapsed(Date.now());
                this._request_id = requestAnimationFrame(function () { return _this.update(); });
            };
            $mol_perf_serp.prototype.destroyed = function (next) {
                if (next)
        ...
        __decorate([
            $.$mol_mem()
        ], $mol_perf_serp.prototype, "data", null);
        __decorate([
            $.$mol_mem()
        ], $mol_perf_serp.prototype, "text", null);
        $mol.$mol_perf_serp = $mol_perf_serp;
        var $mol_perf_serp_dot = (function (_super) {
            __extends($mol_perf_serp_dot, _super);
            function $mol_perf_serp_dot() {
                return _super !== null && _super.apply(this, arguments) || this;
            ...
            $mol_perf_serp_dot.prototype.enter = function (next) {
                this.hover(true);
            };
            $mol_perf_serp_dot.prototype.leave = function (next) {
                this.hover(false);
            };
            return $mol_perf_serp_dot;
        }($.$mol_perf_serp_dot));
        $mol.$mol_perf_serp_dot = $mol_perf_serp_dot;
    })($mol = $.$mol || ($.$mol = {}));
})($ || ($ = {}));
//serp.view.js.map
