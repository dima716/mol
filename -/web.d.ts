...
declare namespace $ {
    class $mol_select extends $mol_view {
        ...
        nav_components(): any[];
        option_focused(key?: any, force?: $mol_atom_force): any;
...
declare namespace $ {
    class $mol_embed extends $mol_view {
        dom_name(): string;
        uri(): string;
        mime(): string;
        attr(): {
...
declare namespace $ {
    class $mol_webdav extends $mol_http_resource {
...
declare namespace $ {
    class $mol_app_slides extends $mol_book {
        role(): string;
        attr(): {
